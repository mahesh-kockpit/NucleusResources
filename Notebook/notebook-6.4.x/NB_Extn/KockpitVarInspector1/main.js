...
function html_table(jsonVars) {
    ...
    var beg_table = '<div class=\"inspector\"><table id="inspectable" class=\"table fixed table-condensed table-nonfluid \"><col /> \
 <col  /><col /><thead><tr><th >X</th><th >Name</th><th >Type</th><th >Size</th>' + shape_str + '<th >Value</th></tr></thead><tr><td> \
    ...
    varList.forEach(listVar => {
        ...
        beg_table +=
            ...
            '</td><td>' + listVar.varSize + shape_col_str + listVar.varContent +  //_trunc(listVar.varContent, cfg.cols.lenVar)
            '</td></tr>';
    });
    ...
    function code_exec_callback(msg) {
        ...
        requirejs(['nbextensions/KockpitVarInspector1/jquery.tablesorter.min'],
            function() {
    ...
    var varInspector_init = function() {
        ...
        function read_code_init(lib) {
            var libName = Jupyter.notebook.base_url + "nbextensions/KockpitVarInspector1/" + lib;
            $.get(libName).done(function(data) {
                ...
                requirejs(
                        [
                            'nbextensions/KockpitVarInspector1/jquery.tablesorter.min'
                            //'nbextensions/KockpitVarInspector1/colResizable-1.6.min'
                        ],
                        function() {
    ...
    var create_varInspector_div = function(cfg, st) {
        ...
        var varInspector_wrapper = $('<div id="varInspector-wrapper"/>')
            .append(
                ...
                .addClass("header")
                .text("Kockpit Variable Inspector ")
                .append(
                    $("<a/>")
                    .attr("href", "#")
                    .text("[x]")
